...
public class Annotations1  {
	...
	//if the Test case name is starting with an Upper Case letter then-the first Method
	...
	public void gmailApplicationLlaunch()
    {
	...
	{
	System.out.println("******Gmail Application LogIn Functionlality Test Successfull******");
	}
	...
	@Test(enabled=false,description="Gmail Application DrafsMail Test") //this represents to a false Test Case-the TestNG during the
